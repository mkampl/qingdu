...
This document lists all third-party libraries and data sources used by QingDu, along with their licenses.
...
### aiofiles
- **Copyright**: Tin Tvrtkovic and contributors
- **Repository**: https://github.com/Tinche/aiofiles
- **License**: Apache-2.0

### python-multipart
- **Copyright**: Andrew Dunham and contributors
- **Repository**: https://github.com/andrew-d/python-multipart
- **License**: Apache-2.0

### bcrypt
- **Copyright**: The Python Cryptographic Authority
- **Repository**: https://github.com/pyca/bcrypt
- **License**: Apache-2.0

### tenacity
- **Copyright**: Julien Danjou and contributors
...
- **Description**: Complete HSK vocabulary list (HSK 1-9) with pinyin and English translations

---

## License Compatibility

All third-party dependencies used in this project are licensed under permissive open-source licenses (MIT, BSD-3-Clause, Apache-2.0) that are fully compatible with the MIT License under which QingDu is distributed.

## Complete Dependency List

For a complete list of all dependencies with their versions, see `requirements.txt`.

---

_This file was last updated: November 2025_
